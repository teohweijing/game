...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { application_id: @promotion.application_id, description: @promotion.description }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { application_id: @promotion.application_id, description: @promotion.description }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
